...
import com.example.junghwanpark.todolist.data.Contract;
import com.example.junghwanpark.todolist.data.DBHelper;
...
public class MainActivity extends AppCompatActivity implements AddToDoFragment.OnDialogCloseListener, UpdateToDoFragment.OnUpdateDialogCloseListener{
    ...
    private Spinner mySpinner; // i have created the Spinner variable to use show four categories
    //private CheckBox cb;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //This will make the variable myadapter by storing the string and show the drop down of the
        //four categories that i made on the strings.xml
    ...
    //This method will grab all the year, month, and day and update it
    @Override
    ...
    //This will add all the todolist on the database by using the contract class
    ...
    //This method will remove the todolist on the database
    ...
    //This methods will update the datapase by using the put
